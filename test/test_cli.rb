...
class TestCli < Test::Unit::TestCase
  ...
  def test_should_delegate_server_status_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-status", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_changeplan_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-changeplan", "thevserverid", "thenewplan"]))
  end
  ...
  def test_should_delegate_server_add_ip_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-addip", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_boot_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-boot", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_reboot_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-reboot", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_shutdown_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-shutdown", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_suspend_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-suspend", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_resume_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-resume", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_check_exists_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-check-exists", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_terminate_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-terminate", "thevserverid"]))
  end
  ...
  def test_should_delegate_server_rebuild_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments(["server-rebuild", "thevserverid", "--template", "thetemplate"]))
  end
  ...
  def test_should_delegate_server_create_to_server
    ...
    assert_equal "theresult", Solusvm::Cli.start(expand_base_arguments([
      "server-create", 
      "thehostname", 
      "thepassword", 
      "--plan", "theplan",
  ...
  def test_should_delegate_node_available_ips_to_general
    ...
    assert_equal "ip1\nip2", Solusvm::Cli.start(expand_base_arguments(["node-available-ips", "thevserverid"]))
  end
  ...
  def test_should_delegate_node_stats_to_general
    ...
    assert_equal "stat1 => val1\nstat2 => val2", Solusvm::Cli.start(expand_base_arguments(["node-stats", "thevserverid"]))
  end
